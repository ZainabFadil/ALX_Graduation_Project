...
urlpatterns = [
    ...
    path('update-status/<int:meal_id>/', views.UpdateMealStatus.as_view(), name='meal_update'),
    path('meal/<int:meal_id>/', views.UpdateMealStatus.as_view(), name='update_meal_status'),
    path('user/<int:user_id>/meals/', views.UserMealView.as_view(), name='users_meals'),
    path('hello/', HelloAuthView.as_view(), name='hello_health_keeper'),
